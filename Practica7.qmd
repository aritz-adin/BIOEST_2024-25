...
<!-- La probabilidad de que el tiempo de uso del dispositivo supere las 19 semanas es de `r round(aux[aux$time=="19","surv"],4)` con un intervalo de confianza al 95\% de $[`r round(aux[aux$time=="19","lower"],4)`, `r round(aux[aux$time=="19","upper"],4)`]$. -->
...
<!-- La probabilidad de que un individuo del grupo "Lev+5FU" viva más de 127 días es de `r round(aux[aux$time=="127","surv"],4)` con un intervalo de confianza al 95\% de $[`r round(aux[aux$time=="127","lower"],4)`, `r round(aux[aux$time=="127","upper"],4)`]$. -->
